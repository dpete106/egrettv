			...
			<div class="row">
              <div class="col-md-4 order-md-2 mb-4">
                ...
                <select class="form-control" name="amount" id="amount" required>
                  ...
                  <option>Total    $25</option>
                  <option>Total    $50</option>
                  <option>Total    $75</option>
                  <option>Total    $100</option>
              </select>
          ...
          <h4 class="mb-3">Billing address</h4>
           ...
           <div class="row">
              ...
              <div class="custom-control custom-radio">
				...
				<div class="alert alert-info" id="error_span">egret.tv does not store your credit card information in any way.  We use Stripe.com, one of the most secure and reputable payment processors available.</div>
              <!-- <div class="custom-control custom-radio">
